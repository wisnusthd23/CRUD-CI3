<div class="container mt-3">
  <div class="card border-primary">
    ...
    <div class="card-body">
      ...
      <?php endif; ?>
      <a href="<?= base_url('kecamatan/tambah') ?>" class="btn btn-success card-title">Tambah data <i class='bx bxs-file-plus'></i></a>
        ...
        <tbody>
          ...
          foreach ($kecamatan as $s) { ?>
            <tr>
              ...
              <td>
              <a href="<?= base_url('kecamatan/edit/' . $s['id_kecamatan']) ?>" class="badge badge-success">Edit</a>
                <a href="<?= base_url('kecamatan/hapus/' . $s['id_kecamatan']) ?>" class="badge badge-danger" onclick="return confirm('Yakin?');">Delete</a>
              </td>
            </tr>
            <?php } ?>
        </tbody>
